...
public class Ex02Frame extends JFrame {
	...
	/*
	 * Código Utilizado para criar os Eventos
	 */
	private void criandoEventos() {
		btnCalcular.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
				if(Double.parseDouble(txtSalarioBruto.getText()) <= 0.0) {
					
					JOptionPane.showMessageDialog(null, "Por favor preencher o campo Salario Bruto.");
...
JOptionPane.showMessageDialog(null, "Por favor preencher o campo Salario Bruto.");
	...
	private void CalcularCampos(Boolean formato) {
		...
		double[] valoresCalculados = Ex02Class.buscarValoresComDesconto(salarioBruto);
